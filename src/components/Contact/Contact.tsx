  ...
  return (
    <div>
      <section className="text-themedarkblue body-font relative lg:flex items-center min-h-screen lg:h-screen justify-center grid lg:grid-cols-2">
        ...
        <div className="relative flex justify-center items-center sm:pt-0 w-full h-full  bg-themeyellow p-5">
              ...
              <Reveal>
                <div className="">
                  <div className=" mr-2  sm:rounded-lg">
                    ...
                    <p className="text-normal text-base sm:text-2xl font-medium text-themedarkblue  mt-2">
                      {t("fillform")}
                    </p>
