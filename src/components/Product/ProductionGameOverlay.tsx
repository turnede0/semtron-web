...
export default function ProductionGameOverlay() {
  ...
  return (
    <div>
      <div className={`relative lg:inline-flex min-h-screen overflow-hidden`}>
        <div>
          <span className={`text-themeyellow text-6xl lg:text-8xl`}>
            {t("gameovelay.message")}
          </span>
        </div>
        <div className="lg:flex">
          <div className="lg:w-1/3 h-full bg-red-500 overflow-hidden">
            <Image
      ...
      <div
        className={`relative lg:flex justify-end bg-themeyellow min-h-screen text-black py-20`}
      >
        <div className=" overflow-hidden h-full lg:w-[50%]">
          <Image className="object-cover" src={Body_side_human} alt=""></Image>
        </div>
        <div className="relative lg:w-1/2 h-[80%] flex justify-center items-center  p-5 z-0 bg-themedarkblue">
